...
import com.binaryz.course.entities.enums.OrderStatus;
import com.binaryz.course.repositories.CategoryRepository;
import com.binaryz.course.repositories.OrderRepository;
import com.binaryz.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner { //implementation to use CommandLineRunner methods
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PAID, u1); // usando o Instante para pegar momento atual com o Parse para formato ISO8601
